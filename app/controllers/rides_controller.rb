class RidesController < ApplicationController
  ...
  private
    ...
    def ride_params
      params.expect(ride: [ :driver_id, :pickup, :dropoff, :ride_type, :invitation_code, :scheduled_time, :available_seats, :status, :rating, :review, :price, :discount, :distance, :estimated_time, :time_taken ])
    end
end
